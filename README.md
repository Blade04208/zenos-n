...
- [x] Initialize `flake.nix` with `nixos-26.05`, `chaotic-nyx`, and `home-manager` inputs.
...
- **Core:** `nixos-26.05` (Unified Stable Base).
...
- **OS Base:** NixOS 26.05 + `chaotic-nyx`.
- **Storage Strategy:**
